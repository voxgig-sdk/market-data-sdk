...
|---|---|---|
| `ts/` | @voxgig-sdk/market-data-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/market-data-sdk \
      --repository voxgig-sdk/market-data-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/market-data-sdk` shows it, and
`npm trust revoke @voxgig-sdk/market-data-sdk --id=<id>` removes it.
