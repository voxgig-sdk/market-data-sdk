...
class MarketDataCacheFeature extends MarketDataBaseFeature
{
    ...
    private function _through(MarketDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
