...
// MarketData SDK streaming feature
...
class MarketDataStreamingFeature extends MarketDataBaseFeature
{
    ...
    private function _iterate(MarketDataResult $result): \Generator
    {
    ...
    private function _streamable(MarketDataContext $ctx): bool
    {
