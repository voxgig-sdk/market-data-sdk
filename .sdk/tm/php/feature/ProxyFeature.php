...
class MarketDataProxyFeature extends MarketDataBaseFeature
{
    ...
    public function init(MarketDataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MarketDataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
