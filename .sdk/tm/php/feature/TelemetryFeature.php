...
// MarketData SDK telemetry feature
...
class MarketDataTelemetryFeature extends MarketDataBaseFeature
{
    ...
    private function _close(MarketDataContext $ctx, bool $ok): void
    {
