...
// MarketData SDK clienttrack feature
...
class MarketDataClienttrackFeature extends MarketDataBaseFeature
{
    ...
    public function PostConstruct(MarketDataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'MarketData-SDK';
