...
class MarketDataNetsimFeature extends MarketDataBaseFeature
{
    ...
    private function _simulate(MarketDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MarketDataContext $ctx, array $applied): void
    {
        $client = $this->client;
