...
// MarketData SDK utility: graphql
//
...
class MarketDataGraphql
{
    ...
    // equivalent.
    public static function body(MarketDataContext $ctx): mixed
    {
    ...
    public static function errors(MarketDataContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
