...
// MarketData SDK utility: fetcher
...
class MarketDataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MarketDataSDK/1.0)';
    ...
    public static function call(MarketDataContext $ctx, string $fullurl, array $fetchdef): array
    {
