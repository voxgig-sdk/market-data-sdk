...
// MarketData SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = MarketDataOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(MarketDataOmni::structfix($now, Struct::undef()))
                        !== json_encode(MarketDataOmni::structfix($val, Struct::undef()))) {
