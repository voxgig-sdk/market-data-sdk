...
class MarketDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MarketDataTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = MarketDataTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = MarketDataTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
