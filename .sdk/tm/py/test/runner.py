...
class MarketDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MarketDataTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = MarketDataTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = MarketDataTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
