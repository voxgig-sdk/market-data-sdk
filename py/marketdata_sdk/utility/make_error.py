# MarketData SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, MarketDataError):
        errmsg = err.msg
    ...
    msg = "MarketDataSDK: " + opname + ": " + errmsg
    ...
    sdk_err = MarketDataError("", msg, ctx)
