...
from marketdata_sdk.core.control import MarketDataControl
...
from marketdata_sdk.core.helpers import get_ctx_prop, to_map
...
class MarketDataContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, MarketDataSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, MarketDataResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MarketDataResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return MarketDataError(code, msg, self)
