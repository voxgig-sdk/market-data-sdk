...
from marketdata_sdk.utility import register

# Load features
from marketdata_sdk.feature.base_feature import MarketDataBaseFeature
from marketdata_sdk.features import _has_feature, _make_feature
...
class MarketDataSDK:
    ...
    def get_utility(self):
        return MarketDataUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MarketDataSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def MarketData(self, data=None) -> "MarketDataEntity":
        ...
        from marketdata_sdk.entity.market_data_entity import MarketDataEntity
        return MarketDataEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "MarketDataSDK":
        if sdkopts is None:
            sdkopts = {}
