...
from marketdata_sdk.core.spec import MarketDataSpec
from marketdata_sdk.core.result import MarketDataResult
from marketdata_sdk.core.response import MarketDataResponse
from marketdata_sdk.core.operation import MarketDataOperation
from marketdata_sdk.core.error import MarketDataError
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return MarketDataError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = MarketDataSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = MarketDataSDK.test(None, None)
        ...
        class TestInitFeature(MarketDataBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(MarketDataBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = MarketDataSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = MarketDataSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = MarketDataSDK.test(None, setup_opts)
