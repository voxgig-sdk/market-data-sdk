# MarketData SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MarketDataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MarketDataSDK(...) and MarketDataSDK.test(...) become
#      MarketDataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "marketdata_sdk"
_SDK_CLASS = "MarketDataSDK"
