...
class MarketDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MarketDataTestRunner.getenv("MARKETDATA_TEST_LIVE")
        override = MarketDataTestRunner.getenv("MARKETDATA_TEST_OVERRIDE")
        ...
        explain = MarketDataTestRunner.getenv("MARKETDATA_TEST_EXPLAIN")
