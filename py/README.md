...
The Python SDK for the MarketData API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.MarketData()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/market-data-sdk/releases)) or
...
```
py/
├── marketdata_sdk.py         -- Main SDK module
