...
type Args struct {
	Entity string         `json:"entity" jsonschema:"market_data"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.MarketDataSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "market-data_list",
		Description: "List records from MarketData. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "market-data_load",
		Description: "Load a single record from MarketData. " +
...
func runOp(client *sdk.MarketDataSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MarketDataSDK, name string) (sdk.MarketDataEntity, error) {
