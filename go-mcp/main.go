// Command MarketData-mcp is an MCP server exposing the MarketData
// SDK as MCP tools.
//
// Two tools are registered:
//
//	MarketData_list  — list records of an entity
//	MarketData_load  — load a single record of an entity
//
