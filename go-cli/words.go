...
func registerSDKWords(r *eng.Registry, client *sdk.MarketDataSDK) {
...
func runOp(client *sdk.MarketDataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
