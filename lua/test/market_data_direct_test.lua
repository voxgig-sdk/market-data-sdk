...
describe("MarketDataDirect", function()
  it("should direct-load-market_data", function()
    local setup = market_data_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-market_data", setup.live and "live" or "unit")
