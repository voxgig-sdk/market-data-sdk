...
function runner.env_override(m)
  local live = runner.getenv("MARKET_DATA_TEST_LIVE")
  local override = runner.getenv("MARKET_DATA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MARKET_DATA_TEST_EXPLAIN")
