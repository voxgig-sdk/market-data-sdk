...
describe("MarketDataEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MARKETDATA_TEST_MARKET_DATA_ENTID JSON to run live")
      return
    end
...
function market_data_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MARKETDATA_TEST_MARKET_DATA_ENTID")
  ...
  if env["MARKETDATA_TEST_LIVE"] == "TRUE" then
