...
Results: Successful response with 24-hour ticker statistics.
...
| --- | --- | --- | --- |
| MarketData | `load` | `GET /api/v3/ticker/24hr` | See reference |

## Connect to the API

- Binance Market Data API Server: `https://data-api.binance.vision`
...
- `market-data_list`: List records for an entity. No active entity supports this operation.
- `market-data_load`: Load one record for an entity. Supported entities: `market_data`.
