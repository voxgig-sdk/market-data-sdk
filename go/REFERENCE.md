# MarketData Golang SDK Reference

Complete API reference for the MarketData Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *MarketDataSDK`
...
#### `MarketData(data map[string]any) MarketDataEntity`
