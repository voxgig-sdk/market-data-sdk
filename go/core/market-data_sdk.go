...
func (sdk *MarketDataSDK) OptionsMap() map[string]any {
...
func (sdk *MarketDataSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *MarketDataSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *MarketDataSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MarketDataSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *MarketDataSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *MarketDataSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("MarketDataSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *MarketDataSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MarketDataSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("MarketDataSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *MarketDataSDK) MarketData(data map[string]any) MarketDataEntity {
