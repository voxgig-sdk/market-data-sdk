...
func NewMarketDataEntity(client *core.MarketDataSDK, entopts map[string]any) *MarketDataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MarketDataEntity) GetName() string { return e.name }
...
func (e *MarketDataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MarketDataEntity) Deleted() bool {
	return e.deleted
}


func (e *MarketDataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMarketDataEntity(e.client, opts)
}

func (e *MarketDataEntity) Data(args ...any) any {
...
func (e *MarketDataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an MarketData; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MarketDataEntity) DataTyped(data ...MarketData) MarketData {
	if len(data) > 0 {
		return typedFrom[MarketData](e.Data(asMap(data[0])))
	}
	return typedFrom[MarketData](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through MarketData (all fields
// optional at the wire level).
func (e *MarketDataEntity) MatchTyped(match ...MarketData) MarketData {
	if len(match) > 0 {
		return typedFrom[MarketData](e.Match(asMap(match[0])))
	}
	return typedFrom[MarketData](e.Match())
}
...
func (e *MarketDataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MarketDataEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MarketDataLoadMatch and returns an MarketData. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MarketDataEntity) LoadTyped(reqmatch MarketDataLoadMatch, ctrl map[string]any) (MarketData, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return MarketData{}, err
	}
	return typedFrom[MarketData](res), nil
}



func (e *MarketDataEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *MarketDataEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MarketDataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MarketDataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MarketDataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
