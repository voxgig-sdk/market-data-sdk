# MarketData TypeScript SDK Reference

Complete API reference for the MarketData TypeScript SDK.
...
```ts
new MarketDataSDK(options?: object)
```
...
#### `MarketDataSDK.test(testopts?, sdkopts?)`
...
**Returns:** `MarketDataSDK` instance in test mode.
...
Return the parent `MarketDataSDK` instance.
