...
The TypeScript SDK for the MarketData API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.MarketData()` — each with a small set of operations (`load`)
...
| `tester(testopts?, sdkopts?)` | `MarketDataSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `MarketDataSDK.test(testopts?, sdkopts?)` | `MarketDataSDK` | Create a test-mode client. |
...
| `client` | `client(): MarketDataSDK` | Return the parent SDK client. |
...
market-data/
├── src/
│   ├── MarketDataSDK.ts        # Main SDK class
