...
function envOverride(m) {
    if ('TRUE' === process.env.MARKET_DATA_TEST_LIVE ||
        'TRUE' === process.env.MARKET_DATA_TEST_OVERRIDE) {
    ...
    m.MARKET_DATA_TEST_EXPLAIN = process.env.MARKET_DATA_TEST_EXPLAIN || m.MARKET_DATA_TEST_EXPLAIN;
    return m;
}
