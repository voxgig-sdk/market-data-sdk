...
(0, node_test_1.describe)('MarketDataEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.MarketDataSDK.test();
...
function basicSetup(extra) {
    ...
    let client = __1.MarketDataSDK.test(options, extra);
    ...
    if (live) {
        ...
        client = new __1.MarketDataSDK(merge([
