...
class MarketDataRbacFeature extends MarketDataBaseFeature
{
    ...
    private function _required(MarketDataContext $ctx): ?string
    {
    ...
    private function _reject(MarketDataContext $ctx, string $required): void
    {
    ...
    private function _track(MarketDataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
