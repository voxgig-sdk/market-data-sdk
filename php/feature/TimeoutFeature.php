...
// MarketData SDK timeout feature
...
class MarketDataTimeoutFeature extends MarketDataBaseFeature
{
    ...
    private function _with_timeout(MarketDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MarketDataContext $_ctx, float $ms): void
    {
        $client = $this->client;
