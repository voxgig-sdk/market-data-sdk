...
// MarketData SDK ratelimit feature
...
class MarketDataRatelimitFeature extends MarketDataBaseFeature
{
    ...
    private function _acquire(MarketDataContext $ctx): void
    {
    ...
    private function _track(MarketDataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
