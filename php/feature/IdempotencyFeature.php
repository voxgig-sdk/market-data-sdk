...
// MarketData SDK idempotency feature
...
class MarketDataIdempotencyFeature extends MarketDataBaseFeature
{
    ...
    private function _mutating(MarketDataContext $ctx): bool
    {
