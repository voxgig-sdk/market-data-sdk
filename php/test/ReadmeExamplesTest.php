...
// MarketData SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MarketDataSDK::test)
...
{
    private const SDK_CLASS = 'MarketDataSDK';
    ...
    private const SDK_BASE = 'marketdata_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../marketdata_sdk.php';
