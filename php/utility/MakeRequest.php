...
// MarketData SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class MarketDataMakeRequest
{
    public static function call(MarketDataContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new MarketDataResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new MarketDataResponse($fetched);
        } else {
