...
// MarketData SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class MarketDataTransformResponse
{
    public static function call(MarketDataContext $ctx): mixed
    {
        ...
        $transform = MarketDataHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
